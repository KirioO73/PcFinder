...
public class CameraSource {
     ...
     *
     * @throws IOException if the camera's preview texture or DisplayActivity could not be initialized
     */
     ...
     * @throws IOException if the supplied surface holder could not be used as the preview DisplayActivity
     */
    @RequiresPermission(Manifest.permission.CAMERA)
        ...
        synchronized (mCameraLock) {
            ...
            if (mCamera != null) {
                ...
                try {
                    ...
                    // SurfaceTexture, if the developer wants to DisplayActivity a preview we must use a
                    // SurfaceHolder.  If the developer doesn't want to DisplayActivity a preview we use a
     ...
     * parameters.  It also sets the camera's DisplayActivity orientation and rotation.
     *
